    ...
    useEffect(() => {
        const checkLpjGate = async () => {
            ...
            try {
                ...
                console.error("Error checking LPJ gate status:", err);
            } finally {
                setCheckingActive(false);
            }
        };
            ...
            <div className="flex items-center justify-center min-h-screen bg-slate-50 p-6">
                <div className="bg-white max-w-md w-full p-8 rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-100 flex flex-col items-center text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-xl font-black text-slate-800 tracking-tight uppercase leading-none">Pengisian LPJ Ditutup</h2>
                        <p className="text-[10px] font-black text-rose-500 uppercase tracking-widest leading-none">Jendela Laporan Realisasi Dibekukan</p>
                    </div>
                    <p className="text-xs font-bold text-slate-400 leading-relaxed">
                        Maaf, pengisian formulir **Buat Realisasi Anggaran (LPJ)** saat ini sedang dinonaktifkan oleh Bendahara Pusat untuk unit Anda **({unit})**. Silakan hubungi Bendahara Pusat untuk informasi lebih lanjut mengenai jadwal pembukaan kembali.
                    </p>
                    <button 
